...
const AddListingPhotoScreen = ({ navigation, route }) => {
	...
	const [coverPhoto, setCoverPhoto] = useState(
		initialCoverPhoto ? { uri: initialCoverPhoto } : defaultCoverImage
	);
	...
	const handleNext = () => {
		if (!coverPhoto.uri || coverPhoto.uri === defaultCoverImage.uri) {
			Alert.alert(
				'No Cover Photo',
				'Please select a cover photo before proceeding.'
			);
			return;
		}
	...
	return (
		<View style={styles.container}>
			...
			<Text style={styles.subtitle}>
				Photos help guests visualize their stay at your place. Begin with one

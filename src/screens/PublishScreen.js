...
const PublishScreen = ({ navigation }) => {
	return (
		<View style={styles.container}>
			...
			<Image
				source={require('../assets/publish-image.png')}
				style={styles.image}
			/>

			<Text style={styles.title}>You're all set to publish your listing!</Text>
			<Text style={styles.subtitle}>
				Once you publish, you can start welcoming guests and easily update your
				calendar or house rules.
			</Text>
			...
			<View style={styles.buttonContainer}>
				...
				<TouchableOpacity
					...
					onPress={() => alert('Edit Listing pressed')}
				>

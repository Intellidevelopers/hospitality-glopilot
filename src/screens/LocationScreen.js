		...
		<SafeAreaView style={styles.container}>
			...
			<View style={styles.content}>
				<Text style={styles.title}>
					Share basic information about your place
				</Text>
				<Text style={styles.subtitle}>
					Please ensure that you have enough beds to comfortably accommodate all
					your guests.
				</Text>
				...
				<View style={styles.row}>
					...
					<View style={styles.counter}>
						<TouchableOpacity
							onPress={() => decrement(setGuests, guests)}
						...
						<TouchableOpacity
							onPress={() => increment(setGuests, guests)}
							style={styles.counterButton}
						>
				...
				<View style={styles.row}>
					...
					<View style={styles.counter}>
						<TouchableOpacity
							onPress={() => decrement(setBedrooms, bedrooms)}
							style={styles.counterButton}
						>
							<Feather name="minus" size={24} color="gray" />
						</TouchableOpacity>
						...
						<TouchableOpacity
							onPress={() => increment(setBedrooms, bedrooms)}
							style={styles.counterButton}
						>
							<Feather name="plus" size={24} color="gray" />
						</TouchableOpacity>
				...
				<TouchableOpacity
					...
					onPress={handleNext} // Replace 'NextScreen' with your actual next screen
				>

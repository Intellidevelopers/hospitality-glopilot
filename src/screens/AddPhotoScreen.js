	...
	const handleNext = async () => {
		...
		try {
			...
			const { data } = await axios.post(
				`${apiUrl}/vendor-house/listing-stage-2`,
				options,
				{
					headers: {
			...
			if (data) {
				Alert.alert('Photo added', 'Photo added successfully');
			...
			{isLoading ? (
				...
				<View style={styles.container}>
					...
					<Text style={styles.subtitle}>
						Photos help guests visualize their stay at your place. Begin with
						one and add more later if you like.
					</Text>

	...
	return (
		<SafeAreaView style={styles.Container}>
			...
			<View style={styles.Header}>
				<Text style={styles.HeaderText} size={30}>
			...
			>
				...
				<View style={styles.radioTextContainer}>
					...
					<Text style={styles.description}>
						Guests have their own private room for sleeping. Other areas could
						be shared.
					</Text>
				</View>
			</TouchableOpacity>
